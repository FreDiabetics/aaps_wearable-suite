...
path = Path("app-mobile/src/main/kotlin/app/aapswear/mobile/SugarliciousWatchScreen.kt")
text = r'''package app.aapswear.mobile
...
internal fun SugarliciousWatchScreen(
    ...
    Column(
        modifier = Modifier
            .fillMaxWidth()
            .menuSwipeNavigation(DashboardScreen.WATCH, onNavigate)
